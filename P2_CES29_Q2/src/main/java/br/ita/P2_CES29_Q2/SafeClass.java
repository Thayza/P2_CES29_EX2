...
public class SafeClass {
	public final void SafeMethod(String file) throws Exception{
		
		Pattern pattern = Pattern.compile("[^A-Za-z0-9._]"); // nome do arquivo com um padrão
	    ...
	    if (opr.equals("R")){
			...
			try {
				...
				System.out.print("Arquivo Inexistente para leitura!!\n");
				throw new Exception();
			} 
		}
